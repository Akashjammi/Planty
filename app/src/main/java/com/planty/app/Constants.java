...
public class Constants {
    ...
    public static Typeface getFont1Bold(Context context) {
        if (font1_bold == null)
            font1_bold = Typeface.createFromAsset(App.getAppContext().getAssets(), "mavenpro_bold.ttf");
        return font1_bold;
    }
    ...
    public static Typeface getFont1Regular(Context context) {
        if (font1_regular == null)
            font1_regular = Typeface.createFromAsset(App.getAppContext().getAssets(), "mavenpro_regular.ttf");
    ...
    public static Typeface getFont1Light(Context context) {
        if (font1_light == null)
            font1_light = Typeface.createFromAsset(App.getAppContext().getAssets(), "mavenpro_medium.ttf");
        return font1_light;
    }
